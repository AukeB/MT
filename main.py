...
interval_arr = np.array([
	['1',  '3',  'b3',  '5',  'b5',  '#5',  '6',  '7',   'maj7', '9',  'b9',  '#9',  '11', '#11', '13', 'b13'],
	['C',  'E',  'Eb',  'G',  'Gb',  'G#',  'A',  'Bb',  'B',    'D',  'Db',  'D#',  'F', 'F#', 'A', 'Ab'], 
	['G',  'B',  'Bb',  'D',  'Db',  'D#',  'E',  'F',   'F#',   'A',  'Ab',  'A#',  'C', 'C#', '', ''], 
	['D',  'F#', 'F',   'A',  'Ab',  'A#',  'B',  'C',   'C#',   'E',  'Eb',  'E#',  'G', 'G#', '', ''], 
	['A',  'C#', 'C',   'E',  'Eb',  'E#',  'F#', 'G',   'G#',   'B',  'Bb',  'B#',  'D', 'D#', '', ''], 
	['E',  'G#', 'G',   'B',  'Bb',  'B#',  'C#', 'D',   'D#',   'F#', 'F',   'F##', 'A', 'A#', '', ''], 
	['B',  'D#', 'D',   'F#', 'F',   'F##', 'G#', 'A',   'A#',   'C#', 'C',   'C##', 'E', 'E#', '', ''],
	['Cb', 'Eb', 'Ebb', 'Gb', 'Gbb', 'G',   'Ab', 'Bbb', 'Bb',   'Db', 'Dbb', 'D',   '', '', '', ''],
	['F#', 'A#', 'A',   'C#', 'C',   'C##', 'D#', 'E',   'E#',   'G#', 'G',   'G##', '', '', '', ''],
	['Gb', 'Bb', 'Bbb', 'Db', 'Dbb', 'D',   'Eb', 'Fb',  'F',    'Ab', 'Abb', 'A',   '', '', '', ''],
	['C#', 'F',  'Fb',  'G#', 'G',   'G##', 'A#', 'B',   'B#',   'D#', 'D',   'D##', '', '', '', ''], 	
	['Db', 'F',  'Fb',  'Ab', 'Abb', 'A',   'Bb', 'Cb',  'C',    'Eb', 'Ebb', 'E',   '', '', '', ''],	
	['Ab', 'C',  'Cb',  'Eb', 'Ebb', 'E',   'Fb', 'Gb',  'G',    'Bb', 'Bbb', 'B',   '', '', '', ''], 
	['Eb', 'G',  'Cb',  'Bb', 'Bbb', 'B',   'Cb', 'Db',  'D',    'F',  'Fb',  'F#',  '', '', '', ''],
	['Bb', 'D',  'Db',  'F',  'Fb',  'F#',  'G',  'Ab',  'A',    'C',  'Cb',  'C#',  '', '', '', ''],
	['F',  'A',  'Ab',  'C',  'Cb',  'C#',  'D',  'Eb',  'E',    'G',  'Gb',  'B#',  '', '', '', '']
	])
